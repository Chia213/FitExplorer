"""Updated models for Exercise and Set

Revision ID: 91ac31c7cfd2
Revises: d972cb1e6db6
Create Date: 2025-03-07 13:13:49.170998
...
revision: str = '91ac31c7cfd2'
down_revision: Union[str, None] = 'd972cb1e6db6'
...
def upgrade() -> None:
    ...
    op.drop_index('ix_custom_exercises_category', table_name='custom_exercises')
    ...
    op.drop_index('ix_routines_id', table_name='routines')
...
def downgrade() -> None:
    ...
    sa.Column('goal_weight', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True),
    ...
    sa.Column('is_cardio', sa.BOOLEAN(), autoincrement=False, nullable=True),
    ...
    sa.Column('intensity', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('notes', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('exercise_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['exercise_id'], ['exercises.id'], name='sets_exercise_id_fkey'),
    ...
    op.create_index('ix_routines_id', 'routines', ['id'], unique=False)
    ...
    sa.Column('bodyweight', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('notes', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('user_id', sa.INTEGER(), autoincrement=False, nullable=True),
    ...
    sa.Column('category', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('user_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='custom_exercises_user_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='custom_exercises_pkey')
    )
    op.create_index('ix_custom_exercises_name', 'custom_exercises', ['name'], unique=False)
    op.create_index('ix_custom_exercises_id', 'custom_exercises', ['id'], unique=False)
    op.create_index('ix_custom_exercises_category', 'custom_exercises', ['category'], unique=False)
    # ### end Alembic commands ###
