...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      {/* Hero Header with Fitness Theme - Mobile Optimized */}
      <motion.div
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 md:py-12">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-4 sm:space-y-0">
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              <Link
                to="/profile"
                className="p-2 sm:p-3 bg-white/20 hover:bg-white/30 rounded-full transition-all duration-200 backdrop-blur-sm"
              >
        ...
        >
          ...
          <motion.div variants={fadeInUp}>
            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 sm:mb-6 space-y-2 sm:space-y-0">
              ...
              <div className="flex items-center space-x-2 text-sm text-muted-foreground">
                <FaBolt className="w-4 h-4 text-accent" />
                <span className="hidden sm:inline">Power up your fitness</span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
              {quickActions.map((action, index) => (
                ...
                >
                  <Link to={action.link}>
                    <Card className={`p-4 sm:p-6 hover:shadow-2xl transition-all duration-300 cursor-pointer group border-0 ${action.bgColor} relative overflow-hidden`}>
                      {/* Badge */}
                      {action.badge && (
                        <div className="absolute top-2 right-2 sm:top-3 sm:right-3">
                          <span className={`px-2 py-1 text-xs font-bold rounded-full ${
                            action.badge === 'HOT' ? 'bg-destructive text-destructive-foreground' : 
                            action.badge === 'NEW' ? 'bg-primary text-primary-foreground' : 
                      ...
                      <div className="relative z-10">
                        <div className="flex items-center space-x-3 sm:space-x-4 mb-3 sm:mb-4">
                          <div className={`p-3 sm:p-4 rounded-2xl bg-gradient-to-r ${action.gradient} text-white group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
                            <action.icon className="w-6 h-6 sm:w-7 sm:h-7" />
                          </div>
                          <div className="flex-1 min-w-0">
                            <h3 className="font-bold text-base sm:text-lg text-card-foreground group-hover:text-muted-foreground transition-colors truncate">
                              {action.title}
                            </h3>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center text-xs sm:text-sm font-medium text-muted-foreground group-hover:text-foreground transition-colors">
          ...
          <motion.div variants={fadeInUp}>
            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 sm:mb-6 space-y-2 sm:space-y-0">
              ...
              <div className="flex items-center space-x-2 text-sm text-muted-foreground">
                <FaChartBar className="w-4 h-4 text-accent" />
                <span className="hidden sm:inline">Keep pushing forward!</span>
                <span className="sm:hidden">Keep pushing!</span>
              </div>
            </div>
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
              <motion.div
                ...
                className="relative"
              >
                <Card className="p-4 sm:p-6 bg-gradient-to-br from-red-50 to-orange-50 dark:from-red-900/20 dark:to-orange-900/20 border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                  <div className="flex items-center justify-between">
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center mt-1 sm:mt-2">
                        <FaArrowUp className="w-3 h-3 text-accent mr-1" />
                        <span className="text-xs text-accent">+2 this week</span>
                      </div>
                    </div>
                    <div className="p-3 sm:p-4 bg-gradient-to-r from-red-500 to-orange-500 rounded-2xl shadow-lg">
                      <FaFire className="w-6 h-6 sm:w-8 sm:h-8 text-white" />
                    </div>
                  </div>
                </Card>
              </motion.div>
              ...
              <motion.div
                ...
                className="relative"
              >
                <Card className="p-4 sm:p-6 bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                  <div className="flex items-center justify-between">
                    <div className="flex-1 min-w-0">
                      <p className="text-2xl sm:text-3xl font-bold text-foreground mb-1">
                      ...
                      <div className="flex items-center mt-1 sm:mt-2">
                        <FaClock className="w-3 h-3 text-primary mr-1" />
                        <span className="text-xs text-primary">45min today</span>
                      </div>
                    </div>
                    <div className="p-3 sm:p-4 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-2xl shadow-lg">
              ...
              <motion.div
                ...
                className="relative"
              >
                <Card className="p-4 sm:p-6 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                  <div className="flex items-center justify-between">
                    <div className="flex-1 min-w-0">
                      <p className="text-2xl sm:text-3xl font-bold text-foreground mb-1">
                    ...
                    <div className="p-3 sm:p-4 bg-gradient-to-r from-green-500 to-emerald-500 rounded-2xl shadow-lg">
                      <FaBullseye className="w-6 h-6 sm:w-8 sm:h-8 text-white" />
                    </div>
                  </div>
                </Card>
              </motion.div>
              ...
              <motion.div
                ...
                className="relative"
              >
                <Card className="p-4 sm:p-6 bg-gradient-to-br from-yellow-50 to-amber-50 dark:from-yellow-900/20 dark:to-amber-900/20 border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                  <div className="flex items-center justify-between">
                    <div className="flex-1 min-w-0">
                      <p className="text-2xl sm:text-3xl font-bold text-foreground mb-1">
                    ...
                    <div className="p-3 sm:p-4 bg-gradient-to-r from-yellow-500 to-amber-500 rounded-2xl shadow-lg">
              ...
              {features.map((feature, index) => (
                ...
                >
                  <Link to={feature.link}>
                    <Card className="p-4 sm:p-6 hover:shadow-lg transition-all duration-200 cursor-pointer group">
                      <div className="text-center">
                        <div className="flex justify-center mb-3 sm:mb-4">
                          <feature.icon className={`w-6 h-6 sm:w-8 sm:h-8 ${feature.color} group-hover:scale-110 transition-transform duration-200`} />
                        </div>
                        <h3 className="font-semibold text-gray-900 dark:text-white mb-2 group-hover:text-gray-700 dark:group-hover:text-gray-300 transition-colors text-sm sm:text-base">
                          {feature.title}
                        </h3>
          ...
          <motion.div variants={fadeInUp}>
            <Card className="p-6 sm:p-8 text-center bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                >
                  <FaDumbbell className="w-12 h-12 sm:w-16 sm:h-16 mx-auto text-white/80" />
                </motion.div>
                
                <blockquote className="text-lg sm:text-2xl font-bold mb-3 sm:mb-4">
                ...
                <div className="flex flex-col sm:flex-row justify-center space-y-3 sm:space-y-0 sm:space-x-4">
                  ...
                  >
                    <Link
                      to="/workout-log"
                      className="block bg-white text-indigo-600 px-4 sm:px-6 py-2 sm:py-3 rounded-full font-bold hover:bg-gray-100 transition-colors duration-200 shadow-lg text-sm sm:text-base"
                    >
                      Start Workout Now
                    </Link>
                  </motion.div>
                  ...
                  >
                    <Link
                      ...
                      className="block bg-white/20 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-full font-bold hover:bg-white/30 transition-colors duration-200 backdrop-blur-sm text-sm sm:text-base"
                    >
                      Generate AI Workout
                    </Link>
                  </motion.div>
          ...
          {/* Daily Challenge - Mobile Optimized */}
          <motion.div variants={fadeInUp}>
            <Card className="p-4 sm:p-6 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border-0">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between space-y-3 sm:space-y-0">
                <div className="flex items-center space-x-3 sm:space-x-4">
                  <div className="p-2 sm:p-3 bg-gradient-to-r from-green-500 to-emerald-500 rounded-2xl">
                ...
                <div className="flex items-center space-x-2 sm:space-x-3">
                  ...
                  <button className="bg-primary text-white px-3 sm:px-4 py-2 rounded-lg font-medium hover:bg-primary/90 transition-colors text-sm sm:text-base">
                    Complete
                  </button>
                </div>
              </div>
