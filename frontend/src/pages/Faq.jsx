      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-8 relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 rounded-lg shadow-sm dark:bg-gray-800 border border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          />
        </div>
